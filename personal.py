...
STRIPE_PAYMENT_INTENT_CLIENT = 'payments.test.client.IntegrationEnvironmentStripePaymentIntentClient'
STRIPE_PAYOUT_CLIENT = 'payments.test.client.IntegrationEnvironmentStripePayoutClient'

############################################################################### 
# EVERYTHING BELOW THIS COMES FROM personal.sample.py in the web repo
###############################################################################
